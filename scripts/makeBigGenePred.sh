...
sed 's/MSY/chrY/g' ${SCRIPTPATH}/../data/Genes/faang_refseq_ensembl.gtf > ${SCRIPTPATH}/../data/Genes/faang_refseq_ensembl.renamed.gtf
${SCRIPTPATH}/../tools/gtfToGenePred -genePredExt ${SCRIPTPATH}/../data/Genes/faang_refseq_ensembl.renamed.gtf ${SCRIPTPATH}/../data/Genes/faang_refseq_ensembl.genePred
